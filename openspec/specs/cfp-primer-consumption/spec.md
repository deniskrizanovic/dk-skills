# cfp-primer-consumption Specification

## Purpose

Define how the `dk-cosmic-csv-to-cfp` skill consumes the coach's shipped COSMIC
rules primer at measurement time, without re-deriving it per run.

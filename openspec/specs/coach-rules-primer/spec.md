# coach-rules-primer Specification

## Purpose

Define the distilled COSMIC rules primer artifact shipped by the
`dk-cosmic-counting-coach` skill, its version stamping, regeneration procedure,
and the architecture decision behind it.
